...
import http.DELETE;
import http.Field;
import http.FieldMap;
import http.FormUrlEncoded;
import http.GET;
import http.HEAD;
import http.HTTP;
import http.Header;
import http.HeaderMap;
...
public class RequestFactory {
    ...
    private final @Nullable okhttp3.Headers headers;
    ...
    static final class Builder {
        ...
        private void parseMethodAnnotation(Annotation annotation) {
            ...
            } else if (annotation instanceof http.Headers) {
                String[] headersToParse = ((http.Headers) annotation).value();
